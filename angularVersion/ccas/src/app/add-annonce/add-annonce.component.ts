...
export class AddAnnonceComponent implements OnInit {
  ...
  constructor(private userService: UserService, private fb: FormBuilder, private annonceService : AnnonceService) {
    this.addAnnonceForm = fb.group({
      ...
      photos: fb.control(['https://cdn.pixabay.com/photo/2012/11/02/13/02/car-63930_960_720.jpg'], Validators.required),
  ...
  submitForm(){
    ...
    let dataReady = {"title": formInfo.title, "description":formInfo.description, "shortDescription":formInfo.shortDescription, "circulationYear": formInfo.circulationYear, "kilometers": formInfo.kilometers, "price": formInfo.price };
